...
const LeadFormWithoutImage: React.FC<LeadFormModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-end">
      <div className="relative bg-white text-black w-full md:w-[400px] rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
...
export default LeadFormWithoutImage;
