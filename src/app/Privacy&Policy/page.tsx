      ...
      <main className="min-h-screen bg-[var(--white)] text-[var(--text)]">
        <section className="w-full py-16 px-6 md:px-20 lg:px-40">
          <div className=" rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 mt-28">
            ...
            <article className="prose prose-sm md:prose-base max-w-none text-justify">
              ...
              <ul>
                ...
                <li>
                  ...
                  from the Service infrastructures itself (for example, the
                  duration of a page visit).
                </li>
                <li>
                  <strong>Website</strong> refers to Ethical Infrastructures,
                  accessible from{" "}
                  <a
                    href="https://ethicalinfrastructure.vercel.app"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    https://ethicalinfrastructure.vercel.app
                  </a>
                </li>
                <li>
              ...
              <p>
                ...
                any personal information that You have provided to Us. Please
                note, however, that We may need to retain certain information
            ...
            <footer className="text-center mt-10 border-t border-gray-200 pt-6 text-sm text-gray-500">
